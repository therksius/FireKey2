...
#cs
Commented out the includes above. All it seemed to need was $GUI_EVENT_CLOSE for _SoundQuery() anyway, so I just alt. declared it in there.
#ce
...
Global $asControlTypes[30], $LVS_REPORT__SoundGetSetQueryUse, $LVS_NOSORTHEADER__SoundGetSetQueryUse
...
Func _SoundQuery()
	...
	Local $hListView = GUICtrlCreateListView("MixerID|ComponentType|CompInst|ControlType|Value", 10, 10, 380, 530, BitOR($LVS_REPORT__SoundGetSetQueryUse, $LVS_NOSORTHEADER__SoundGetSetQueryUse))
	...
	Local $iMsg, $__SoundQuery_GUI_EVENT_CLOSE = -3
	Do
		$iMsg = GUIGetMsg()
	Until $iMsg = $__SoundQuery_GUI_EVENT_CLOSE
